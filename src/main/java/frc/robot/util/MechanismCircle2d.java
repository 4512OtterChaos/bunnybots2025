...
public class MechanismCircle2d {
    ...
    public MechanismCircle2d(
        ...
        if (setBackground) createBackground();
        if (setStripe) createStripe();
    }
    ...
    public void setAngle(Angle angle) {
        setBackgroundAngle(Rotation2d.fromDegrees(angle.in(Degrees)));
        setStripeAngle(Rotation2d.fromDegrees(angle.in(Degrees)));
    }
}