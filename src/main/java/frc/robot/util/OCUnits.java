...
public class OCUnits {
    ...
    public static final MomentOfInertiaUnit PoundSquareInches = PoundsInchesSquaredPerSecond.mult(RadiansPerSecond); //Has about 6 decimals of accuracy in conversion at least compared to google conversion
